...
public class DbHelper extends SQLiteOpenHelper {
    ...
    static String email = auth.getCurrentUser().getEmail();
    /** Database name */
    private static String DATABASE_NAME = email + "database";
    ...
    public DbHelper(Context context) {
        super(context, email+"database", null, DATABASE_VERSION);
    ...
    @Override
    // change this so that updating doesn't delete old data
...
// ############################# get methods ####################################### //
    ...
    public Pill getPillByName(String pillName) {
        ...
        android.database.Cursor c = db.rawQuery(dbPill, null);
     ...
     */
    public java.util.List<Pill> getAllPills() {
        DATABASE_NAME = email + "database";
        java.util.List<Pill> pills = new ArrayList<>();
        String dbPills = "SELECT * FROM " + PILL_TABLE;

        SQLiteDatabase db = getReadableDatabase();
        android.database.Cursor c = db.rawQuery(dbPills, null);
     ...
     */
    public java.util.List<Alarm> getAllAlarmsByPill(String pillName) throws URISyntaxException {
        java.util.List<Alarm> alarmsByPill = new ArrayList<Alarm>();
     ...
     */
    public java.util.List<Alarm> getAlarmsByDay(int day) {
        java.util.List<Alarm> daysAlarms = new ArrayList<Alarm>();
    ...
    public Alarm getAlarmById(long alarm_id) throws URISyntaxException {
        ...
        DATABASE_NAME = email + "database";
        SQLiteDatabase db = getReadableDatabase();
        android.database.Cursor c = db.rawQuery(dbAlarm, null);
     ...
     * @throws URISyntaxException
     */
    private java.util.List<Alarm> combineAlarms(java.util.List<Alarm> dbAlarms) throws URISyntaxException {
        DATABASE_NAME = email + "database";
        java.util.List<String> timesOfDay = new ArrayList<>();
        java.util.List<Alarm> combinedAlarms = new ArrayList<>();
    ...
    public java.util.List<History> getHistory() {
        DATABASE_NAME = email + "database";
        java.util.List<History> allHistory = new ArrayList<>();
        String dbHist = "SELECT * FROM " + HISTORIES_TABLE;

        SQLiteDatabase db = getReadableDatabase();
        android.database.Cursor c = db.rawQuery(dbHist, null);
...
// ############################### delete methods##################################### //
    ...
    public void deletePill(String pillName) throws URISyntaxException {
        SQLiteDatabase db = this.getWritableDatabase();
        java.util.List<Alarm> pillsAlarms;
