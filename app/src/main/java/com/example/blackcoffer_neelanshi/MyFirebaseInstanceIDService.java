...
public class MyFirebaseInstanceIDService extends FirebaseInstanceIdService {
    ...
    private static final String SUBSCRIBE_TO = "Messages/" + FirebaseInstanceId.getInstance().getToken();
    ...
    public void onTokenRefresh() {
        ...
        */
        ...
        FirebaseFirestore.getInstance().document("Users/" + FirebaseAuth.getInstance().getCurrentUser().getEmail()).update("TokenId", token);
    }
}
