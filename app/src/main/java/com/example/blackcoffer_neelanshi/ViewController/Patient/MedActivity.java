...
public class MedActivity extends AppCompatActivity implements ActionBar.TabListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Med Schedule");
    ...
    public void onTabReselected(ActionBar.Tab arg0, FragmentTransaction arg1) {
        ((TextView)arg0.getCustomView()).setTextSize(17);
    }
    ...
    public void onTabSelected(ActionBar.Tab selectedtab, FragmentTransaction arg1) {
        ...
        ((TextView)selectedtab.getCustomView()).setTextSize(17);
    }

    @Override
    public void onTabUnselected(ActionBar.Tab arg0, FragmentTransaction arg1) {
        ((TextView)arg0.getCustomView()).setTextSize(10);
    }
